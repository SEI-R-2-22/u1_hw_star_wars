...
mv princess_leia.txt luke_skywalker.txt obi_wan.txt millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon /Users/andrewwhitford/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star