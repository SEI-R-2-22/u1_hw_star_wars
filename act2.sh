...
touch princess_leia && echo Help me Obi-wan.>>princess.leia.txt
...
touch han_solo.txt chebacca.txt
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
mv obi_wan.txt priness_leia.txt luke_skywalker.txt millenium_falcon
