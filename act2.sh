...
# 5. Inside the millenium_falcon, create two files: han_solo.txt and han_solo.txt
touch han_solo.txt touch han_solo.txt
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
mv obi_wan.txt princess_leia.txt luke_skywalker.txt millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon ../  mv millenium_falcon/ empire/