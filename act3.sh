...
rm -r death_star
// Some of these might still be wrong -_-
// I tried to re-do this section but my terminal changes from last night were still saved (even though the section above was empty)