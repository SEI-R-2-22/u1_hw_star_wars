...
mv empire/death_star/chewbacca.txt empire/death_star/millenium_falcon && mv empire/death_star/han_solo.txt empire/death_star/millenium_falcon && mv empire/death_star/princess_leia.txt empire/death_star/millenium_falcon && mv empire/death_star/luke_skywalker.txt empire/death_star/millenium_falcon
