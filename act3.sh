...
# Move the whole crew from the millenium_falcon directory into the death_star directory. HINT: * following a directory will grab all files/folders inside of a directory (directory/*)
 mv millenium_falcon/* /home/pregan17/GA/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star
...
mv millenium_falcon /home/pregan17/GA/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt /home/pregan17/GA/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire
