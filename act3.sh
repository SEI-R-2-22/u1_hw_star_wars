...
mv rebellion/death_star/millenium_falcon/* rebellion/death_star 
...
mv chewbacca.txt luke_skywalker.txt princes_leia.txt han_solo.txt millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv rebellion/death_star/millenium_falcon rebellion
