...
mv luke_skywalker.txt princess_leia.txt obi_wan.txt han_solo.txt chewbacca.txt death_star/
...
mv luke_skywalker.txt princess_leia.txt obi_wan.txt han_solo.txt chewbacca.txt millenium_falcon/
