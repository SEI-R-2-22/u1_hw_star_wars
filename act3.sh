...
mv star_wars/empire/death_star/han_solo.txt star_wars/empire/death_star/chewbacca.txt star_wars/empire/death_star/luke_skywalker.txt star_wars/empire/death_star
/princess_leia.txt star_wars/empire/death_star/millenium_falcon
