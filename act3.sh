...
mv obi_wan.txt princess_leia.txt luke_skywalker.txt death_star
...
mv han_solo.txt luke_skywalker.txt princess_leia.txt millenium_falcon/
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon ..mv millenium_falcon .. mv millenium_falcon/ rebellion/
