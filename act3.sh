...
star_wars git:(main) ✗ trash empire/death_star/obi_wan.txt
...
➜  star_wars git:(main) ✗ mv empire/death_star/chewbacca.txt millenium_falcon 
➜  star_wars git:(main) ✗ mv empire/death_star/han_solo.txt millenium_falcon 
➜  star_wars git:(main) ✗ mv empire/death_star/princess_leia.txt millenium_falcon 
➜  star_wars git:(main) ✗ mv empire/death_star/luke_skywalker.txt millenium_falcon 
