...
mv empire/death_star/milennium_falcon/*  empire/death_star/
...
# Remember: darth_vader remains in the death_star and emperor_palpatine is still in the empire.
 mv death_star/chewbacca.txt death_star/milennium_falcon 
mv death_star/han_solo.txt death_star/milennium_falcon
mv death_star/luke_skywalker.txt death_star/milennium_falcon
mv death_star/princess_leia.txt death_star/milennium_falcon 
# 4. Move the millenium_falcon back into the rebellion directory.
mv  empire/death_star/milennium_falcon rebellion/
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv empire/death_star/darthvader.txt empire 
