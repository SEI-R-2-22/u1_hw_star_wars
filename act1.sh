...
➜  empire git:(main) ✗ cd darth_vadee.txt
cd: no such file or directory: darth_vadee.txt
➜  empire git:(main) ✗ echo "...heavy breathing..."> darth.vader.txt
# 5. Inside the empire directory, create a file called emperor_palpatine.txt
# 6. Inside the empire directory, create a directory called death_sta
empire git:(main) ✗ mkdir emperor_palpatine.txt
